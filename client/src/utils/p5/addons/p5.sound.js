...
;(function (modules) {
    ...
    function (module, __webpack_exports__, __webpack_require__) {
        ...
        ;(function (global) {
            ...
            var Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1__ =
                __webpack_require__(0)
    ...
    function (module, exports, __webpack_require__) {
        ...
        (__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
            ...
            return (
                ...
                (o.TimelineSignal.prototype.cancelScheduledValues = function (
                    e,
                ) {
                    return (
                        (e = this.toSeconds(e)),
                ...
                (o.Clock.prototype._loop = function () {
                    for (
                        ...
                        this.frequency &&
                            ((this._nextTick +=
                                1 /
                                this.frequency.getValueAtTime(this._nextTick)),
                            e === o.State.Started &&
        ...
        (__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
            ...
            return (
                ...
                Object.defineProperty(o.Context.prototype, "lag", {
                    get: function () {
                        var t =
                            this._computedUpdateInterval - this._updateInterval
                ...
                (o.Emitter.prototype.emit = function (t) {
                    if (this._events) {
                        ...
                        if (this._events.hasOwnProperty(t))
                            for (
                                var i = this._events[t], r = 0, n = i.length;
                                r < n;
                                r++
                            )
                                i[r].apply(this, e)
                    ...
                    if (1 < this._timeline.length) {
                        ...
                        if (0 <= i)
                            if (this._timeline[i].time === e) {
                                ...
                                this._timeline = this._timeline.slice(0, i + 1)
                        else this._timeline = []
                    } else
        ...
        (__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
            ;(o.Frequency = function (e, t) {
                ...
                (o.Frequency.prototype._ticksToUnits = function (e) {
                    return (
                        1 /
                        ((60 * e) / (o.Transport.bpm.value * o.Transport.PPQ))
                    )
                }),
        ...
        (__WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
            return (
                ...
                (o.TransportTime.prototype.toSeconds = function () {
                    return (
                        this._expr() + (this._plusNow ? o.Transport.seconds : 0)
                    )
                }),
                ...
                },
                {
                    ...
                    value: function logAverages(octaveBands) {
                        ...
                        for (
                            ...
                            if (
                                specIndexFrequency > octaveBands[octaveIndex].hi
                            ) {
                                octaveIndex++
                            }
                ...
                },
                {
                    ...
                    value: function scale(inMin, inMax, outMin, outMax) {
                        ...
                        if (arguments.length === 4) {
                            mapOutMin =
                                p5.prototype.map(outMin, inMin, inMax, 0, 1) -
                                0.5

                            mapOutMax =
                                p5.prototype.map(outMax, inMin, inMax, 0, 1) -
                                0.5
                        } else {
            ...
            onsetDetect_createClass(OnsetDetect, [
                {
                    ...
                    value: function update(fftObject, callback) {
                        this.energy =
                            fftObject.getEnergy(this.freqLow, this.freqHigh) /
                            255
                    ...
                    value: function noteAttack(_note, _velocity) {
                        var secondsFromNow =
                            arguments.length > 2 && arguments[2] !== undefined
                                ...
                                : 0
                        var acTime =
                            main.audiocontext.currentTime + secondsFromNow
                        ...
                        if (typeof velocity === "number") {
                            var maxRange =
                                (1 / this._voicesInUse.getValueAtTime(acTime)) *
                                2
                ...
                },
                {
                    ...
                    value: function _updateAfter(time, value) {
                        if (this._voicesInUse._searchAfter(time) === null) {
                            ...
                            var nextTime =
                                this._voicesInUse._searchAfter(time).time
