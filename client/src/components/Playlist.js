        ...
        <>
            <div className="searchItem">
                ...
                <div className="siDesc">
                    ...
                    <span className="siTaxiOp">
                        Release Date:{" "}
                        <span id="releaseDate">August 28, 2015</span>
                    </span>
            ...
            <div className="searchItem">
                ...
                <div className="siDesc">
                    ...
                    <span className="siTaxiOp">
                        Release Date:{" "}
                        <span id="releaseDate">June 25, 2021</span>
                    </span>
                    <span className="siSubtitle">
            ...
            <div className="searchItem">
                ...
                <div className="siDesc">
                    ...
                    <span className="siTaxiOp">
                        Release Date:{" "}
                        <span id="releaseDate">November 21, 1975</span>
                    </span>
                    <span className="siSubtitle">
            ...
            <div className="searchItem">
                ...
                <div className="siDesc">
                    ...
                    <span className="siTaxiOp">
                        Release Date:{" "}
                        <span id="releaseDate">December 8, 1881</span>
                    </span>
                    <span className="siSubtitle">
